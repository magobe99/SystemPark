package com.Sistempark.SenaSP.commons;

import com.Sistempark.SenaSP.dao.ReporteVentasServiceAPI;
import com.Sistempark.SenaSP.commons.JasperReportManager;
import com.Sistempark.SenaSP.commons.ReporteVentasDTO;
import com.Sistempark.SenaSP.commons.ReporteVentasServiceImpl;
import com.Sistempark.SenaSP.commons.TipoReporteEnum;
...
public class ReporteVentasServiceImpl implements ReporteVentasServiceAPI {
	...
	public ReporteVentasDTO obtenerReporteVentas(Map<String, Object> params)
		...
		String fileName = "Sistempark_report";
	 ...
	 */
    @Override
	public ReporteVentasDTO obtenerReporteVentasEvn(Map<String, Object> params)
			throws JRException, IOException, SQLException {
		String fileName = "reporte_sistempark_evento";
		ReporteVentasDTO dto = new ReporteVentasDTO();
		String extension = params.get("tipo").toString().equalsIgnoreCase(TipoReporteEnum.EXCEL.name()) ? ".xlsx"
				: ".pdf";
		dto.setFileName(fileName + extension);
